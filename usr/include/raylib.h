...
RLAPI void ClearBackground(unsigned int color);                          // Set background color (framebuffer clear color)
...
RLAPI void DrawRectangle(int posX, int posY, int width, int height, unsigned int color);                        // Draw a color-filled rectangle
